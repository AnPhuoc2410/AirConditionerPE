...
public partial class AirConditionerShop2024DbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AirConditionerId).HasName("PK__AirCondi__EE2EB739EC637E0E");
        ...
        {
            entity.HasKey(e => e.MemberId).HasName("PK__StaffMem__0CF04B38CF41563E");

            entity.ToTable("StaffMember");

            entity.HasIndex(e => e.EmailAddress, "UQ__StaffMem__49A14740C6C43741").IsUnique();
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__Supplier__4BE666B4FD9AEA37");
